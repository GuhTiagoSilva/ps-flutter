...
import 'ocean_app_theme.dart';
import 'ocean_list_view.dart';

class OceanHomeScreen extends StatefulWidget {
  @override
  _OceanHomeScreenState createState() => _OceanHomeScreenState();
}

class _OceanHomeScreenState extends State<OceanHomeScreen>
    with TickerProviderStateMixin {
  late AnimationController animationController;
  Future<List<Ocean>> oceanList = OceanService().findAll();
  ...
  Container buildListView(List<Ocean> oceans) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          final int count = oceans.length > 10 ? 10 : oceans.length;
  ...
  void showDemoDialog({required BuildContext context}) {
    showDialog<dynamic>(
      ...
      builder: (BuildContext context) => CalendarPopupView(
        ...
        onCancelClick: () {}, maximumDate: DateTime(2021),
      ),
    );
  }
