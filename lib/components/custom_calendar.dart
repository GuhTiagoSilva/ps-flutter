                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: OceanAppTheme.buildLightTheme().dividerColor,
                      ),
                    ),
                    child: Material(
          ...
          child: Center(
            child: Text(
              ...
              style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500,
                  color: OceanAppTheme.buildLightTheme().primaryColor),
            ),
          ),
        ),
      );
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: getIsItStartAndEndDate(date)
                                  ? OceanAppTheme.buildLightTheme().primaryColor
                                  : Colors.transparent,
                              borderRadius:
                                  const BorderRadius.all(Radius.circular(32.0)),
                              border: Border.all(
